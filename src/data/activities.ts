...
export const activities: Record<number, Activity[]> = {
  ...
  5: [
    ...
    { lat:34.7042, lng:135.4960, title:"Conrad Osaka",                     time:"01:30 PM",   type:"hotel",      desc:"Hilton's architectural flagship towering 58 floors above Nakanoshima island, offering sweeping 360-degree skyline and river views. Unpack for 3 nights." , duration:"check-in"},
    { lat:34.6687, lng:135.5014, title:"Dotonbori & Kushikatsu Daruma",   time:"07:00 PM",   type:"restaurant", desc:"Crispy golden skewers in Shinsekai and the buzzing neon canal under the Glico Running Man sign. Strict no-double-dipping rule enforced." , duration:"~2 hrs"},
  ],
  6: [
  ...
  10: [
    ...
    { lat:35.6717, lng:139.7645, title:"Hyatt Centric Ginza Tokyo",        time:"01:30 PM",   type:"hotel",      desc:"Chic lifestyle hotel on Ginza's Namiki-dori, surrounded by world-class dining, boutiques, and galleries. Base for 9 nights." , duration:"check-in"},
  ...
  16: [
    { lat:35.7275, lng:139.7675, title:"Yanaka Ginza — Shitamachi Quarter", time:"09:30 AM",  type:"shop",       desc:"Tokyo's most charming preserved pre-war neighborhood — historic wooden temples, winding cat alleys, and traditional street food stalls." , duration:"~2.5 hrs"},
    { lat:35.7188, lng:139.7765, title:"Tokyo National Museum, Ueno",      time:"01:00 PM",   type:"museum",     desc:"Japan's oldest and largest museum housing national treasures, samurai armor, lacquerware, and ukiyo-e woodblock prints." , duration:"~2.5 hrs"},
...
export const meals: Record<number, DayMeals> = {
  ...
  7:  { breakfast: { text: "Artisan bakery in Umeda", booked: false }, lunch: { text: "Kuromon Market seafood stalls · fresh uni, tuna, and grilled scallops", booked: false }, dinner: { text: "Koshien Stadium bento boxes & Hanshin-branded beer at the baseball game", booked: false } },
  8:  { breakfast: { text: "Ekiben on the Shinkansen speeding past Mount Fuji", booked: false }, lunch: { text: "Hakone-Yumoto buckwheat soba upon mountain arrival", booked: false }, dinner: { text: "Gora Kadan in-room Kaiseki banquet · twelve courses served on ancestral lacquerware", booked: true  } },
  9:  { breakfast: { text: "Gora Kadan traditional ryokan breakfast in-room", booked: true  }, lunch: { text: "Owakudani black eggs & volcanic spring ramen", booked: false }, dinner: { text: "Gora Kadan second evening bespoke mountain kaiseki", booked: true  } },
  10: { breakfast: { text: "Bakery & Table Hakone terrace breakfast overlooking Lake Ashi", booked: false }, lunch: { text: "Shinjuku ramen bar upon Tokyo arrival", booked: false }, dinner: { text: "Ginza Hinoki Counter Sushi · seasonal omakase nigiri", booked: true  } },
  11: { breakfast: { text: "Tsukiji Outer Market · tamagoyaki and sea urchin breakfast", booked: false }, lunch: { text: "Tempura Daikokuya Asakusa (1887) · dark sesame oil tempura", booked: true  }, dinner: { text: "Sumida riverfront izakaya · grilled river fish and craft beer", booked: false } },
  12: { breakfast: { text: "Nihonbashi kissaten morning toast and siphon coffee", booked: false }, lunch: { text: "Kanda Yabu Soba (1880) · cold zarusoba with heritage dipping sauce", booked: false }, dinner: { text: "Cotton Club jazz lounge supper plates & wine", booked: false } },
  13: { breakfast: { text: "Aoyama café pour-over coffee and croissants", booked: false }, lunch: { text: "Maisen Tonkatsu Aoyama · crispy pork cutlet in converted bathhouse", booked: false }, dinner: { text: "Nonbei Yokocho · smoky yakitori skewers and cold Sapporo in Shibuya", booked: false } },
  14: { breakfast: { text: "Mitaka bakery morning set before Ghibli entry", booked: false }, lunch: { text: "Kichijoji Harmonica Yokocho · artisan ramen and gyoza counter", booked: false }, dinner: { text: "Bar High Five bespoke cocktails & Ginza small plates", booked: true  } },
  15: { breakfast: { text: "Ivy Place Daikanyama · buttermilk pancakes under the terrace trees", booked: false }, lunch: { text: "Nakameguro riverside soba and cold matcha", booked: false }, dinner: { text: "Roppongi Robata hearth dining · fresh Hokkaido seafood grilled over binchotan", booked: true  } },
  16: { breakfast: { text: "Kayaba Coffee Yanaka (1938) · iconic egg toast in historic machiya", booked: false }, lunch: { text: "Ueno Park lotus pond café lunch", booked: false }, dinner: { text: "Yurakucho Izakaya Row yakitori under the elevated train arches", booked: true  } },
...
export const dayMeta: Record<number, { title: string; lodging: string }> = {
  ...
  5:  { title: "Day 5: Arashiyama Bamboo & Westward to Osaka",         lodging: "Conrad Osaka" },
  6:  { title: "Day 6: Bayview Golf & Certified Kobe Beef",            lodging: "Conrad Osaka" },
  7:  { title: "Day 7: Whisky Valley & Koshien Stadium",               lodging: "Conrad Osaka" },
  8:  { title: "Day 8: Mountain Mist, Onsen & Ryokan Shiatsu",        lodging: "Gora Kadan" },
  9:  { title: "Day 9: Volcanic Vents & Open-Air Sculpture",          lodging: "Gora Kadan" },
  10: { title: "Day 10: Romancecar to Tokyo & Ginza Omakase",          lodging: "Hyatt Centric Ginza" },
  11: { title: "Day 11: Tsukiji Sashimi, Senso-ji & Sumida River",    lodging: "Hyatt Centric Ginza" },
  12: { title: "Day 12: Sumo at Dawn, Damascus Knives & Kanda Soba",   lodging: "Hyatt Centric Ginza" },
  13: { title: "Day 13: Meiji Shrine, Aoyama Gardens & Shibuya Night", lodging: "Hyatt Centric Ginza" },
  14: { title: "Day 14: Studio Ghibli, Inokashira & Bar High Five",    lodging: "Hyatt Centric Ginza" },
  15: { title: "Day 15: Daikanyama T-Site, Nakameguro & Mori Art",     lodging: "Hyatt Centric Ginza" },
  16: { title: "Day 16: Historic Yanaka Shitamachi & Ueno Park",       lodging: "Hyatt Centric Ginza" },
